...
// CODE HERE
const totalPopulation = populations.reduce((acc,current)=>{
  return acc+current;
},0)
...
const ordersTotal = orders.map((order)=>{
  priceWithTax = order.price * (1 + order.tax);
